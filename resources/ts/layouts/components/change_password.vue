...
//submit forms
const Editpassword = () => {
  axios.put(environment.API_URL + 'auth/user-profile/changepass/' + props.userid.id, { newpass: newpass.value }, {
...
<template>
  <section>
    ...
    <VCard flat>
      <VToolbar color="info">
        <VToolbarTitle class="text-h5" style="color: white;">Change Password</VToolbarTitle>
      </VToolbar>
      ...
      <VCardText class="d-flex justify-end flex-wrap gap-3">
        <VBtn variant="tonal" color="error" @click.prevent="closeDialog">
          Cancel
        </VBtn>
    ...
    <VSnackbar v-model="successfully" :timeout="2000"
      ...
      <VIcon>tabler:discount-check</VIcon>&nbsp; Success! Changed your password.
    </VSnackbar>
