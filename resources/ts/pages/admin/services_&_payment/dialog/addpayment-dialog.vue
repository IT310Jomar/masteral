...
const post_payment = () => {
  ...
  axios.post(environment.API_URL + "auth/admin/post-payment-method", formData)
    .then((response) => {
...
<template>
  <section>
    <VCard title="Add Payment Method"  max-height="550px" class="d-flex flex-column flex-grow-1 overflow-auto">
    <VDivider />
    <VForm ref="refsubmit" @submit.prevent="onSubmit">
      <VCardText>
        ...
        <VRow style="padding-left: 22%" v-if="qrcode === 'Yes'">
          <VCol xs="12">
            <div v-if="imageUrlPayment" class="circle-container" style="text-align: center">
              <VImg
                :src="imageUrlPayment"
                alt="Uploaded Image"
                class="circle-image"
            ...
            <div v-else class="circle-container" style="text-align: center">
              <VImg
                :src="logo"
                alt="Uploaded Image"
                class="circle-image"
