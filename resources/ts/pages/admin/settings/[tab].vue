...
import AccountSettingsAccount from '@/pages/admin/settings/AccountSettings.vue'
import { ref } from 'vue'
...
// tabs
const tabs = [
  { title: 'Maintenance', icon: 'tabler-users', tab: 'maintenance' },
  ...
  <div>
    ...
    >
      <VTab
        ...
        :key="item.icon"
        :value="item.tab"
        :to="{ name: 'admin-settings-tab', params: { tab: item.tab } }"
      >
        <VIcon
          size="20"
          start
...
<route lang="yaml">
meta:
  navActiveLink: admin-settings-tab
</route>
