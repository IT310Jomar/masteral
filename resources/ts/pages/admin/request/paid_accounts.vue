...
import approvePaid from "@/pages/admin/request/PaidDialog/approve_paid-dialog.vue";
import rejectPaid from "@/pages/admin/request/PaidDialog/reject_paid-dialog.vue";
import viewPaid from "@/pages/admin/request/PaidDialog/view_paid-dialog.vue";
...
<template>
  <section>
    <v-card-title>Paid Account List</v-card-title>
          ...
          <VTable ref="tableRef">
            ...
            <tbody>
              <tr v-for="(row, index) in paginatedPendingData" :key="row.id">
                ...
                <td class="text-center">
                  {{ moment(row.date_of_payment).format("MMMM DD, YYYY") }}
                </td>
                <td class="text-center">
                  <VChip
                    color="success"
                ...
                <td class="text-center">
                  ...
                  >
                    ...
                    <VMenu activator="parent">
                      <VList>
                        <VListItem @click="approveform(row)">
                          <template #default>
                            <VIcon>solar:like-broken</VIcon>
                            Approve
                          </template>
                        </VListItem>
                        <VListItem @click="rejectform(row)">
                          <template #default>
    ...
    <VDialog v-model="approveDialog" max-width="450">
      <approvePaid
        :row="paidRow"
        @currentTab="currentTab = 'approved'"
