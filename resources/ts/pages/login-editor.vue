  ...
  >
    <VCard flat :max-width="500" class="mt-12 mt-sm-0 pa-4">
      <VCardText>
        ...
        <h5 class="text-h5 font-weight-semibold mb-1">Welcome! Editor👋🏻</h5>
        <p class="mb-0">
      ...
      <VCol>
        <VCardText>
          <div style="text-align: center;">
            <VIcon color="error" size="80" icon="mdi-information-outline"/>
        ...
        <VCardText>
          <div class="float-right">
            ...
            <VBtn @click="disabled_dialog = false" color="error">Ok!</VBtn>
          </div>
        </VCardText>
      </VCol>
    </VCard>
