...
import editprofile from "@/pages/client/profile/ViewProfile/dialog/editDialog.vue";
...
const getprofile =() => {
  ...
  .then ((response)=> {
    ...
    // console.log(clientprofile.value.user_id === client_id[0].user_id)
...
<template>
  <section>
    ...
    <VCard class="mb-4">
      ...
      <VCardText v-else-if="clientprofile && clientprofile.user_id === client_id[0].user_id">
        <v-row>
